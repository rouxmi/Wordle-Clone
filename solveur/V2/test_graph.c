...
void test_best_word_recur()
{
    ...
    node * n=node_add_all_words(name);
    //char c= best_char_simple(n);
    node* child = node_get_by_label(n->listEdge, 'F');
        printf("ok");
    node_print(child);
    node* child2 = node_get_by_label(child->listEdge, 'O');
        printf("ok");
    node_print(child2);
    node* child3 = node_get_by_label(child2->listEdge, 'U');
        printf("ok");
    node_print(child3);
    node* child4 = node_get_by_label(child3->listEdge, 'R');
        printf("ok");
    node_print(child4);
    node* child5 = node_get_by_label(child4->listEdge, 'N');
        printf("ok");
    node_print(child5);
    motpondere mp;
    mp = node_best_word(n);
